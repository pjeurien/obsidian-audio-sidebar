...
- Click any folder in the file explorer, then click **Load from selected folder** to populate the sidebar with all audio files in that folder
...
1. Open the file explorer and click a folder containing audio files
